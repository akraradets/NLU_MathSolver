...
def dependency_parse_penn(tree_file):
                ...
                p = Popen("java -cp "+parser_directory+" edu.stanford.nlp.trees.EnglishGrammaticalStructure -outputFormat -treeFile ./constituency_trees/"+ tree_file +" -keepPunct -basic ",shell = True, stdout=PIPE, stderr=STDOUT)
                idx = 0;
                ...
                print("\nDependency Parsing Time Elased (Per one constituency tree): ", (time.time() - now), "seconds.\n")
